...
caseBranchList      : caseBranchItem ( ';' caseBranchItem )* ;
caseBranchItem      : caseConstants ':' statement;
caseConstants       : constant (',' constant)*;
constant            : sign?(IDENTIFIER | unsignedNumber) | characterConstant | stringConstant;
